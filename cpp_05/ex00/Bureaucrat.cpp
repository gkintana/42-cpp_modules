...
/*   Updated: 2022/06/11 19:48:40 by gkintana         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char *Bureaucrat::GradeTooHighException::what() const throw() {
	return PURPLE "Bureaucrat grade exceeds the highest possible grade" DEFAULT;
}

const char *Bureaucrat::GradeTooLowException::what() const throw() {
	return PURPLE "Bureaucrat grade is below the lowest possible grade" DEFAULT;
}
